...
# Mario Tomé Core
**Desarrollador Full Stack** — especialidad en Python (PyQt5, Flask) · Experiencia en Java/Android · Proyectos móviles y de escritorio.
...
## Stacks principales
**Lenguajes**: Python · Java · JavaScript · PHP · Dart (Flutter) · SQL  
**Frameworks / Librerías**: PyQt5 · Flask · Spring (básico) · Flutter · React (básico)  
**Bases de datos / Infra**: SQLite · MySQL · Supabase · REST APIs  
**Herramientas**: Git · GitHub Actions · MAMP · Android Studio · VSCode
